...
public class UserFunctions {
    ...
    // User is young (15-24)
	public static BiPredicate<User, LocalDate> userIsYoung = (user, today) -> Optional.ofNullable(user.getDateOfBirth()).isPresent() && ((today.getYear() - user.getDateOfBirth().getYear() > 15) && (today.getYear() - user.getDateOfBirth().getYear() < 24));
